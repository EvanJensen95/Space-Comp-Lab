...
function getNumbersSquared(numbers) {
  ...
  for (let i = 0; i < numbers.length; i++) {
    let squaredValue = number[i] * number[i]
    answers.push(squaredValue)
  }
  return answers
}
...
// ANSWER: Both of these functions are using methods that itterate through each letter, just in different ways.
